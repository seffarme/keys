...
emprunt_pigalle = FraisRecurrent.new({
    nom: "Prêt amortissable sur 25 ans",
    montant: "1200",
    categorie: "Crédit",
    recurrence: "Mensuel",
